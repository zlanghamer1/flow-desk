...
| Yahoo Finance `wss://streamer.finance.yahoo.com/?version=2` (added 2026-09-23) | Real-time last trade for the one name open in the Day trade tab. | The page, only while that tab is open | Unofficial and undocumented; no key, no Origin check. Same Yahoo terms as the row above: personal, non-commercial use, no redistribution. | **Blocked.** |
